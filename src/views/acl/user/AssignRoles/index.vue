...
// 多选状态
const checkAll = computed(() => checkedRoles.value.length === userRoles.value.allRolesList.length)
// 不确定状态（多选框中的-）
...
const assignRoles = async () => {
  ...
  aclStore.getUserPageList(props.currentUser.currentPage, props.currentUser.pageSize)
}
// 请求获取当前用户角色的方法
...
// 监听用户角色，初始化展示
watch(() => userRoles.value.assignRoles, () => {
